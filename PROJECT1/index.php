	...
	<header>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.php"><img src="Assets/Templates/Main/images/icons/logo.png" alt="IMG-LOGO"></a>
			</div>
					...
					<div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
                        ...
                        <div class="filter-col5 p-b-27">
							...
							<ul>
								...
								<input class="form-control" type="number" onkeyup="productCheck()" name="txt_min" id="txt_min">
                                <br>
                                <label for="txt_max">Maximum</label>
								<input class="form-control" type="number" onkeyup="productCheck()" name="txt_max" id="txt_max">
							</ul>
						</div>
					</div>
				</div>
		...
		<div class="container">
			...
			<div class="p-t-40">
				...
				<p class="stext-107 cl6 txt-center">
					...
					Copyright &copy;
					<script>document.write(new Date().getFullYear());</script> All rights reserved |  Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by Hridya
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
