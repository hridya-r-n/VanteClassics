...
if(isset($_GET['rid']))
	{
		$UpQry="update tbl_manufacturer set manufacturer_vstatus=2 where manufacturer_vstatus=1 and manufacturer_id=".$_GET['rid'];
		if($Con->query($UpQry))
	{
		?>
<script>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Accepted Manufacturers</h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="action-links">
                                                <a href="Acceptedmanufacturer.php?rid=<?php echo $row['manufacturer_id']; ?>" class="btn btn-custom-reject btn-sm">Reject</a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
