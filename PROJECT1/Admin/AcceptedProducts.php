                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $i; ?></td>
                                            <td>
                                                <img src="../Assets/Files/Product/Photo/<?php echo $row['product_photo']; ?>" alt="Product Photo" class="img-fluid" style="max-width: 100px;" />
                                            </td>
                                            ...
                                            <td>
                                                <a href="AcceptedProducts.php?rid=<?php echo $row['product_id']; ?>" class="btn btn-custom-reject btn-sm">Reject</a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
