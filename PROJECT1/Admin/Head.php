    ...
    -->
      <div class="sidebar-wrapper">
        ...
        <li class="active ">
          ...
          <li class="active ">
            <a href="DayReport.php">
              <i class="tim-icons icon-chart-bar-32"></i>
              <p>Single-day Report</p>
            </a>
          </li>
          <li class="active ">
        ...
        <div class="modal-footer">
              ...
              <li class="dropdown nav-item">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                  <div class="photo">
                    <img src="../Assets/Templates/Admin/assets/img/adminicon.jpg">
                  </div>
                ...
                <ul class="dropdown-menu dropdown-navbar">
                  ...
                  <li class="nav-link">
                    <a href="ChangePassword.php" class="nav-item dropdown-item">Change Password</a>
                  </li>
                  <div class="dropdown-divider"></div>
                  <li class="nav-link">
                    <a href="../Guest/LogOut.php" class="nav-item dropdown-item">Log out</a>
                  </li>
                </ul>
              </li>
