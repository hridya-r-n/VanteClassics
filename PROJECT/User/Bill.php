...
<html>
  ...
  <body>
    ...
    <section class="main-pd-wrapper" id="content">
      ...
      <br> <br> <br> <br><br>
     <button id="cmd" onClick="printDiv('content')" class="button" style="margin: 0 10px;">Download Bill</button>
   <a href="HomePage.php" id="cmd" class="button" style="margin: 0 10px;">Back to Home</a>
  </div>
  <br> <br>
    </section>
