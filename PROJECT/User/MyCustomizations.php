...
if(isset($_GET['aid'])){
  $UpQry="update tbl_assign set assign_status='".$_GET['st']."' , assign_msg='".$_GET['msg']."'  where assign_id=".$_GET['aid'];
  if($Con->query($UpQry)){
    if($_GET['st']==2){
    ?>
    <script>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td><?php echo $i; ?></td>
                                <td width="150"><?php echo $row['request_date'] ?></td>
...
<script>
  function rejDes(id){
	var msg = prompt("Reason and What to Improve")
	console.log(msg)
	window.location="MyCustomizations.php?aid=" + id + "&msg="+ msg +"&st=3"
