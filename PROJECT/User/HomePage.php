...
<body class="animsition"onload="productCheck()">
			...
			<!-- <div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						<a href="MyProfile.php" class="flex-c-m trans-04 p-lr-25">
							My Account
						</a>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
						...
						<li><a href="HomePage.php">Home</a></li>
							<li class="active-menu">
								...
								<ul class="sub-menu">
									...
									<li><a href="MyComplaints.php">Complaints</a></li>
                                    </ul>
                             </li>
							<li class="active-menu">
								<a href="">My Pages</a>	
								<ul class="sub-menu">
                                    ...
                                    <li><a href="MyCustomizations.php">My Customization</a></li>
							...
							<li>
								<a href="SearchManufacturer.php">Search Manufacturers</a>
							</li>
                            <li>
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<a href="MyCart.php"><div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11" >
					...
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
								<a href="Search.php" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									Shop Now
								</a>
							</div>
						</div>
					...
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="rotateIn" data-delay="1600">
								<a href="SearchManufacturer.php" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									Shop Now
								</a>
							</div>
						</div>
	...
	<section class="bg0 p-t-23">
		<div class="container">
			...
			<div class="row" id="result" style="padding:20px;">
