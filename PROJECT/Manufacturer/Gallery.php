      ...
      <div class="card-body">
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            $id=$_GET['pid'];
              $i = 0;
              $SelQry = "SELECT * FROM tbl_gallery g INNER JOIN tbl_product p ON g.product_id = p.product_id where p.product_id=$id and p.manufacturer_id=".$_SESSION['mid'];
            ...
            <tr>
              ...
              <td><a href="Gallery.php?did=<?php echo $row['gallery_id']; ?>&pid=<?php echo $row['product_id'] ?>" class="btn btn-danger btn-sm">Delete</a></td>
            </tr>
            <?php
              }
            ?>
