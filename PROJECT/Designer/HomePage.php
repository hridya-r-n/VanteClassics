	...
	<header>
		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->		
					<a href="#" class="logo">
						<img src="../Assets/Templates/Main/images/icons/logo.png" alt="IMG-LOGO">
					</a>
					...
					<div class="menu-desktop">
						...
						<li><a href="HomePage.php">Home</a></li>
                            ...
                            <li>
                                <a href="Request.php">Custom Requests</a>
                            </li>
                            <li>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="../Assets/Templates/Main/index.html"><img src="../Assets/Templates/Main/images/icons/logo.png" alt="IMG-LOGO"></a>
			</div>
					...
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
								<a href="Request.php" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									View Your Requests
								</a>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto"> -->
					...
					<!-- <div class="block1 wrap-pic-w">
						...
						<a href="../Assets/Templates/Main/product.html" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
		...
		<div class="container">
			...
			<div class="row isotope-grid">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../Assets/Templates/Main/images/product-01.jpg" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="../Assets/Templates/Main/product-detail.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									Esprit Ruffle Shirt
								</a>
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
									<img class="icon-heart1 dis-block trans-04" src="../Assets/Templates/Main/images/icons/icon-heart-01.png" alt="ICON">
									<img class="icon-heart2 dis-block trans-04 ab-t-l" src="../Assets/Templates/Main/images/icons/icon-heart-02.png" alt="ICON">
								</a>
							</div>
						</div>
					</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women"> --> 
					...
					<!-- <div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../Assets/Templates/Main/images/product-02.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../Assets/Templates/Main/images/product-03.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<!-- <div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../Assets/Templates/Main/images/product-04.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women"> -->
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../Assets/Templates/Main/images/product-05.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item watches">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../Assets/Templates/Main/images/product-06.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../Assets/Templates/Main/images/product-07.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../Assets/Templates/Main/images/product-08.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item shoes">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../Assets/Templates/Main/images/product-09.jpg" alt="IMG-PRODUCT">
				...
				<!-- Block2
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../Assets/Templates/Main/images/product-10.jpg" alt="IMG-PRODUCT">
				...
				<!-- <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men"> -->
					...
					<!-- <div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../Assets/Templates/Main/images/product-11.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men"> --> -->
					...
					<!-- <div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../Assets/Templates/Main/images/product-12.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../Assets/Templates/Main/images/product-13.jpg" alt="IMG-PRODUCT">
				...
				<!-- <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../Assets/Templates/Main/images/product-14.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item watches">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../Assets/Templates/Main/images/product-15.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../Assets/Templates/Main/images/product-16.jpg" alt="IMG-PRODUCT">
		...
		<div class="container">
			<div class="row">
				...
				<h4 class="stext-301 cl0 p-b-30">
					...
					At Vante Classics, we empower talented manufacturers to create and customize high-quality bags for a global market. Our platform facilitates seamless design personalization, efficient product management, and a direct connection to a wide audience. We're dedicated to supporting craftsmanship and helping businesses thrive in the competitive world of bag design.
						</p>
					<ul>
						<!-- <li class="p-b-10">
						...
						<!-- <li class="p-b-10">
							<a href="Complaints.php" class="stext-107 cl7 hov-cl1 trans-04">
								Complaints 
							</a>
						</li> -->
		...
		<div class="container">
			<div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
				<button class="how-pos3 hov3 trans-04 js-hide-modal1">
					<img src="../Assets/Templates/Main/images/icons/icon-close.png" alt="CLOSE">
				</button>
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="images/product-detail-01.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="../Assets/Templates/Main/images/product-detail-01.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="../Assets/Templates/Main/images/product-detail-01.jpg">
									...
									<div class="item-slick3" data-thumb="images/product-detail-02.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="../Assets/Templates/Main/images/product-detail-02.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="../Assets/Templates/Main/images/product-detail-02.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>
									...
									<div class="item-slick3" data-thumb="images/product-detail-03.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="../Assets/Templates/Main/images/product-detail-03.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="../Assets/Templates/Main/images/product-detail-03.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>
