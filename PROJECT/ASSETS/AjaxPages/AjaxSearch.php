...
if (isset($_GET["action"])) {
   ...
   $sqlQry = "SELECT * from tbl_product p inner join tbl_subcategory s on s.subcat_id=p.subcategory_id INNER join tbl_material mt on mt.material_id=p.material_id INNER JOIN tbl_color c on c.color_id=p.color_id inner join tbl_category ct on ct.category_id=s.category_id where TRUE and p.product_vstatus='1'";
               ...
               <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
                            ...
                            <div class='star-rating' style="color: #DEAD6F;font-size:30px;">
	                    	 <?php
                             for ($i = 1; $i <= 5; $i++) {
	                          if ($i <= $averageRating) {
