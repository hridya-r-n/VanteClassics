...
if(isset($_POST['btn_submit']))
{
    ...
    $_SESSION['dname']=$data['designer_name'];
...
<form method="post" id="app">
  <div class="app-view">  
    <header class="app-header">
      ...
      Welcome back,<br/>
      <span class="app-subheading" style="color:rgba(65, 62, 62, 0.45)">
...
<span class="app-subheading"style="color:white">
    Don't have an account?
</span>
  <p>
    <a href="UserRegistration.php" style="font-weight: bold; color: #1f2d93; text-decoration: none;">New User Registration</a><br>
    <a href="ManufacturerRegistration.php" style="font-weight: bold; color: #1f2d93; text-decoration: none;">Manufacturer Registration</a><br>
</p>
</aside>
<!-- partial -->
