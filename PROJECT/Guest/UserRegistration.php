...
if(isset($_POST['btn_register']))
{
	...
	if($resUser->num_rows>0 || $resAdmin->num_rows>0 || $resDes->num_rows>0|| $resMan->num_rows>0){
		?>
		  <script>
	...
	$InsQry="insert into tbl_user(user_name,user_email,user_password,user_address,user_photo,user_contact,place_id) values('$name','$email','$pwd','$address','$photo','$contact','$place')";
	if($Con->query($InsQry))
	{
    ...
    $mail->Password = 'nrzb vabe mswy eyjq'; // Your gmail app password
    $mail->SMTPSecure = 'ssl';
    $mail->Port = 465;
        ...
        <tbody>
          ...
          <tr>
            <td colspan="2" class="text-center">
              ...
              <a id="btn_home" href="../index.php" class="btn btn-primary">Back to Home</a>
            </td>
          </tr>
        </tbody>
      </table>
