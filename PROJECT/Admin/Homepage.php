          ...
          <div class="col-lg-3">
            <div class="card card-chart">
              <div class="card-header ">
                ...
                <h3 class="card-title"><i class="tim-icons icon-delivery-fast text-info "></i><?php $SelQry="Select sum(booking_amount) as amount from tbl_booking b inner join tbl_cart c on b.booking_id=c.booking_id where c.cart_status between 0 and 5";
                $Result = $Con -> query($SelQry);
                $row=$Result->fetch_assoc();
                echo "₹".$row['amount'];
                ?></h3>
          ...
          <div class="col-lg-3">
            <div class="card card-chart">
              <div class="card-header ">
                ...
                <h3 class="card-title"><i class="tim-icons icon-bag-16 text-success "></i><?php $SelQry="Select count(*) as count from tbl_product where product_vstatus=1";
                $Result = $Con -> query($SelQry);
                $row=$Result->fetch_assoc();
                echo $row['count'];
                ?></h3>
          ...
          <div class="col-lg-3">
            <div class="card card-chart">
              <div class="card-header ">
                ...
                <h3 class="card-title"><i class="tim-icons icon-delivery-fast text-info "></i> <?php $SelQry="Select count(*) as count from tbl_booking b inner join tbl_cart c on b.booking_id=c.booking_id where c.cart_status between '0' and '5'";
                $Result = $Con -> query($SelQry);
                $row=$Result->fetch_assoc();
                echo $row['count'];
                ?></h3>
