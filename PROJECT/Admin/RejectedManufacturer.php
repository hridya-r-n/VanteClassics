...
if(isset($_GET['aid']))
	{
		echo $UpQry="update tbl_manufacturer set manufacturer_vstatus=1 where manufacturer_vstatus='2' and manufacturer_id=".$_GET['aid'];
		if($Con->query($UpQry))
	{
		?>
<script>
                ...
                <div class="col-md-24">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Rejected Manufacturers</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="../Assets/Files/Manufacturer/Proof/<?php echo $row['manufacturer_proof']; ?>" target="_blank" rel="noopener noreferrer">Proof</a></td>
                                            <td>
                                            ...
                                            <a href="RejectedManufacturer.php?aid=<?php echo $row['manufacturer_id']; ?>" class="btn btn-custom-accept btn-sm">Accept</a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
